    ...
    return (
        <Container>
            <Row className="d-lg-flex my-5">
                <Col xs={{ order: 'last' }} lg={{ order: 'first' }} className="carousel-text d-flex flex-column justify-content-center">
                ...
                <Col xs={{ order: 'first' }, 12} lg={{ order: 'last' }, 6} className="part1-img">
                    <Image className='img-fluid' src="/img/c2part1.png" alt="management" />
                </Col>
            </Row>
        </Container>
    );
